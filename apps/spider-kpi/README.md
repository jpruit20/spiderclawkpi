...
- the existing `Deploy KPI Frontend and Backend` workflow then deploys production from `master`

This keeps production on the normal `master` branch while removing the manual PR/merge step for validated Claude KPI updates.
